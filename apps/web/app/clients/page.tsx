      ...
      <div className="pf-page-header">
        <div>
          ...
          <p className="pf-subtitle">
            Ügyfélcégek, kapcsolattartók és a hozzájuk
            tartozó projektek.
          </p>
        </div>

        {access.canCreateClient && (
          <Link
            href="/clients/new"
      ...
      {clients.length === 0 ? (
        <div className="pf-empty">
          <p className="font-semibold text-[#424b5e]">
            Még nincs elérhető ügyfélcég.
          </p>
          <p className="mt-1 text-sm">
            {access.canCreateClient
              ? "Hozd létre az első ügyfélcéget."
              : "Jelenleg nincs számodra elérhető ügyfélcég."}
          </p>
        </div>
      ) : (
            ...
            >
                ...
                <div className="flex min-w-0 items-center gap-3.5">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 text-xs text-[#8d96a8]">
                      {client._count.projects} projekt ·{" "}
              ...
              <div className="mt-5 border-t border-[#edf0f5] pt-4">
                ...
                {client.contacts.length === 0 ? (
                  <p className="text-sm text-[#9199a9]">
                  ...
                  <div className="space-y-1.5">
                    {client.contacts
                      ...
                      .map((contact: any) => (
                        <p
                          key={contact.id}
                          className="truncate text-sm text-[#667084]"
                        >
                          <span className="font-semibold text-[#4a5366]">
                            {contact.name}
                          </span>
                          {" · "}
                          {contact.email}
